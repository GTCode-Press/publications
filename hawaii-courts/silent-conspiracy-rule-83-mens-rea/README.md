...
This is where ordinary litigation explanations matter. Petricevic could have entered the case with superior trial experience and a reasonable expectation that a pro se opponent would lose. He also could have sought or accepted a pretrial cross-injunction resolution for ordinary reasons: settlement posture, client risk management, reducing uncertainty, avoiding cost, or avoiding a live evidentiary hearing.

There is also an exposure-based hypothesis. A cross-injunction would have avoided live testimony. It would have reduced exposure around drugs, violence, credibility, and embarrassing background. It would have avoided creating the courtroom sequence that later became the sealed-record problem. If Petricevic expected to win at trial anyway, settlement still could have been attractive because outcome and exposure are separate risks.

That remains a hypothesis. The public record does not resolve motive. The core point requires less: the witness's answer mattered, the text-message exhibit mattered, the question created exposure, and counsel represented the person whose denial benefited from the alleged judicial signal.
...
The trial-preparation point fits here. Petricevic entered with superior trial experience. I was pro se. If he knew or reasonably expected that I would lose, the attraction of pretrial cross-injunction resolution still makes sense under an exposure model. Avoiding trial reduces exposure even where the outcome looks favorable. Routine settlement posture and client risk management remain ordinary explanations. The exposure hypothesis adds another reason: drug questions, violence allegations, credibility conflicts, and embarrassing background can be costly even when the legal result is likely.
...
6. Ask Petricevic, under proper authority, what he understood the gesture to mean, whether he performed a Rule 8.3(b) analysis and, if he invoked Rule 1.6, what separate protected client information he believed a report would disclose, and whether any report was made.
