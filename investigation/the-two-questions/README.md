...
By Ekewaka Lono • Published: February 23, 2026 • Updated: May 12, 2026

Previous reporting in this series has published a firsthand account of what allegedly happened in Judge Wilson M.N. Loo's courtroom — a silent nod allegedly directing a witness to deny, under oath, what the evidence in the court's own file showed the witness had done. That account is published in [The Nod](https://gtcode.com/investigation/the-nod-wilson-loo-silent-felony/). The institutional failure that followed — the Commission's 100% dismissal rate, the 90-day jurisdictional loophole, the sealed record — is documented in [The Zero Commission](https://gtcode.com/investigation/the-zero-commission/).
...
**Evidence standard:** This article does not ask readers to accept the alleged visual signal as publicly proven. It separates the visual claim — a firsthand allegation of a no-head gesture and facial cue — from the audio-confirmable sequence: the question, the answer, the attempted "Let the record show..." statement, the cutoff, and the sealing request. The sealed audio can test the sequence. Credible, disinterested testimony and review of the sealed file can test the visual allegation.

---

The federal theory involving retired Judge Wilson M.N. Loo turns on the cooperation of one person: ████████████. ████████████ is the witness alleged to have received the nonverbal signal. He is also the person whose prior conduct — specifically, his alleged role as an intermediary in LSD distribution on the North Shore — created the factual predicate at issue in the courtroom question.
...
If the witness corroborates the account, the factual dispute narrows. It becomes a case that turns on whether one person, interviewed away from the courtroom and the judge alleged to have signaled him, tells the truth about what happened.
...
████████████ has been carrying this since the trial. A federal investigator offering the standard choice — cooperation or exposure — would ask him to stop carrying the burden of Loo's alleged conduct.
...
This brief does not prove guilt. It shows why standard investigative steps are warranted. The witness is identified. The legal theories are coherent. The statute of limitations provides a defined window. The target is retired and carries no judicial immunity. The unresolved questions are factual and narrow — and they can be tested by witness interviews, line-of-sight review, court-file review, and the sealed audio.

The Department of Justice now controls whether those steps occur, or whether this referral joins the [Commission on Judicial Conduct's annual reports](https://gtcode.com/investigation/the-zero-commission/) — processed, filed, and closed without public evidence of primary-record review.
...
This article does not prove from public materials alone that Judge Loo made the alleged visual signal. It does not prove that the witness will corroborate the account. It does not prove that § 1622 applies to state-court perjury. It does not prove that federal non-response has a single cause. It identifies the shortest factual route for testing the allegation.
...
| --- | --- | --- |
| [The Nod](https://gtcode.com/investigation/the-nod-wilson-loo-silent-felony/) | Feb 12, 2026 | Firsthand allegation of judicial signaling from the bench |
| [The Zero Commission](https://gtcode.com/investigation/the-zero-commission/) | Feb 15, 2026 | 100% dismissal rate: the architecture of judicial unaccountability |
| [The Closed Loop](https://gtcode.com/investigation/the-closed-loop/) | Feb 15, 2026 | Series overview: oversight controlled by the overseen |
| [The Index](https://gtcode.com/investigation/the-index-bing-search-suppression/) | Feb 13, 2026 | Domain-level search suppression of this site |
| [The Aloha Protection Racket](https://gtcode.com/investigation/aloha-protection-racket/) | Aug 26, 2025 | Institutional sequence that produced a protection effect |
| [Wilson Loo: Investigation](https://gtcode.com/investigation/hawaii-justice-system-wilson-loo/) | Jun 12, 2025 | Original investigation into alleged judicial signaling and the Commission |
...
**APA:**
Lono, E. (2026, February 23). The Two Questions: How One Interview Could Test the Wilson Loo Case. *GTCode.com Investigations*. https://gtcode.com/investigation/the-two-questions/ (Archived at https://github.com/GTCode-Press/publications/tree/main/investigation/the-two-questions)

**Chicago:**
Ekewaka Lono. "The Two Questions: How One Interview Could Test the Wilson Loo Case." *GTCode.com Investigations*, February 23, 2026. https://gtcode.com/investigation/the-two-questions/. Archived at https://github.com/GTCode-Press/publications/tree/main/investigation/the-two-questions.
