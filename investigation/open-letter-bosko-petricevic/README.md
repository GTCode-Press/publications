...
You appeared in the First Circuit Court in Honolulu as counsel for ████████████. I appeared pro se. [Judge Wilson M.N. Loo](https://gtcode.com/investigation/hawaii-justice-system-wilson-loo/) presided. The proceeding was recorded by audio only. The record was later sealed at your request.

This letter concerns the professional-responsibility questions arising from the sequence that occurred in that courtroom.

Your client was placed under oath. I [asked a question](https://gtcode.com/investigation/the-two-questions/) that tested his testimony against a text-message exhibit already in the court file. That exhibit was directly relevant to the truthfulness of the testimony being given. As counsel, you had access to the file and were in a position to understand the context in which the question was being asked.
...
**BibTeX:**
    ...
    @article{lono2026openletterbosko,
      ...
      note    = {Last modified 2026-05-13; Archived at \url{https://github.com/GTCode-Press/publications/tree/main/investigation/open-letter-bosko-petricevic}}
    }

**APA:**
Lono, E. (2026, May 6). An Open Letter to Bosko Petricevic, Esq.. *GTCode.com Investigations*. https://gtcode.com/investigation/open-letter-bosko-petricevic/ (Archived at https://github.com/GTCode-Press/publications/tree/main/investigation/open-letter-bosko-petricevic)

**Chicago:**
Ekewaka Lono. "An Open Letter to Bosko Petricevic, Esq.." *GTCode.com Investigations*, May 6, 2026. https://gtcode.com/investigation/open-letter-bosko-petricevic/. Archived at https://github.com/GTCode-Press/publications/tree/main/investigation/open-letter-bosko-petricevic.
